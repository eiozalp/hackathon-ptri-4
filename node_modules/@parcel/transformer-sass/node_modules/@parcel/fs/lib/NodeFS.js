...
function _fsSearch() {
  const data = require("@parcel/fs-search");
...
// require('fs').promises
const realpath = (0, _utils().promisify)(process.platform === 'win32' ? _gracefulFs().default.realpath : _gracefulFs().default.realpath.native);
...
class NodeFS {
  constructor() {
    ...
    _defineProperty(this, "findAncestorFile", _fsSearch().findAncestorFile);

    _defineProperty(this, "findNodeModule", _fsSearch().findNodeModule);

    _defineProperty(this, "findFirstFile", _fsSearch().findFirstFile);
  }
